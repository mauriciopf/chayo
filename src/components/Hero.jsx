...
const Hero = ({ darkMode = false }) => {
  ...
  return (
  <section 
    className={`relative ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} py-16 xs:py-20 sm:py-32 md:py-40 text-center overflow-hidden min-h-screen flex flex-col items-center`} 
    style={{ 
  ...
  >
    ...
    <div
      className="absolute left-1/2 top-1/3 -translate-x-1/2 w-2/3 sm:w-1/2 h-6 sm:h-10 bg-gradient-to-r from-white/40 via-cyan-400/20 to-orange-400/20 opacity-20 sm:opacity-30 blur-xl rounded-full z-10 animate-float"
      aria-hidden="true"
      style={{ pointerEvents: 'none' }}
    />
