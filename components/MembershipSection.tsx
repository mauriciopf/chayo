...
function StartMembershipButton() {
  ...
  return (
    <button
      ...
      className="w-full sm:w-auto px-8 py-4 bg-chayo-accent text-chayo-bg font-sans font-semibold text-sm tracking-wide rounded-sm hover:bg-chayo-accent-hover active:scale-[0.98] transition-all duration-150 min-h-[52px] flex items-center justify-center disabled:opacity-60"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-chayo-border max-w-3xl">
          ...
          <div className="bg-chayo-surface p-8 sm:p-10 flex flex-col gap-6">
            <div>
              ...
              <p className="text-chayo-muted text-sm font-sans">Perfect for personal brands &amp; small businesses</p>
            </div>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={feature} className="flex items-start gap-3 text-sm font-sans text-chayo-text">
          ...
          <div className="bg-chayo-bg p-8 sm:p-10 flex flex-col gap-6 border border-chayo-border">
            <div>
              ...
              <p className="text-chayo-muted text-sm font-sans">For brands that need more volume and priority production</p>
            </div>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={feature} className="flex items-start gap-3 text-sm font-sans text-chayo-muted">
            ...
            <div className="mt-auto pt-2">
              <a
                ...
                className="w-full px-8 py-4 border border-chayo-border text-chayo-text font-sans text-sm tracking-wide rounded-sm hover:border-chayo-accent hover:text-chayo-accent active:scale-[0.98] transition-all duration-150 min-h-[52px] flex items-center justify-center gap-2"
              >
