...
const ChatActionableHints: React.FC<ChatActionableHintsProps> = ({ organizationId }) => {
  ...
  return (
    <>
      <div className="px-4 py-3 bg-gradient-to-r from-gray-50 to-white border-t border-gray-200 flex-shrink-0" style={{ overflowX: 'visible' }}>
        <div className="mx-auto max-w-4xl w-full" style={{ overflowX: 'visible' }}>
          <ActionableHintChips
            key={refreshKey}
