-- COMPLETE Database Reset Script INCLUDING Auth Users
-- WARNING: This will delete ALL users and data from the database
-- Users will need to re-register completely
...
-- Delete auth users (this will require complete re-registration)
...
UNION ALL
SELECT 
  'auth_users' as table_name, COUNT(*) as record_count FROM auth.users; 