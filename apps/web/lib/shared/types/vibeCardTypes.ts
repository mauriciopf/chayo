...
export interface VibeCardData {
  ...
  // Vibe Elements (optional - will have defaults)
  origin_story?: string
  value_badges?: string[]
  ...
  // Connection Elements (optional - can be generated by AI)
...
// Essential field names for vibe card data collection (streamlined to 5 core fields)
